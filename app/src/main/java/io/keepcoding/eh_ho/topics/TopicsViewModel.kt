...
class TopicsViewModel(private val repository: Repository) : ViewModel() {
    ...
    private val _state: MutableLiveData<State> = MutableLiveData<State>().apply { postValue(State.NoTopics) }
    ...
    private fun onTopicsFailure(throwable: Throwable) {
        //TODO
        //Lo ideal sería comprobar el error y mostrarselo al usuario
        _state.postValue(State.NoTopics)
    }
